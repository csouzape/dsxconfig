...
ASCII_BANNER = r"""
  ____  ____  __  __  __  __  ____   _____  ____   ____  ____
 |  _ \|  _ \|  \/  |\ \/ / / __ \ / ____|/ __ \ / __ \|  _ \
 | | | | |_) | |\/| | \  / | |  | | |  __| |  | | |  | | |_) |
 | |_| |  _ <| |  | | /  \ | |  | | | |_ | |  | | |  | |  _ <
 |____/|_| \_\_|  |_|/_/\_\ \____/ \_____|\____/ \____/|_| \_\

"""

MENU_OPTIONS = [
    "export -> generate ~/dsxconfig_restore.sh",
    "summary -> show installed package counts",
    "db -> show adaptation database preview",
    "exit -> quit dsxconfig",
]
    ...
    if shutil.which("fzf"):
        try:
            result = subprocess.run(
                ["fzf", "--prompt", "dsxconfig> ", "--ansi", "--no-sort", "--header=Select an action"],
                input="\n".join(options),
                text=True,
