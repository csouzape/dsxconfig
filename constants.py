...
# Package names or tokens that should be excluded from exported native app lists.
# These are primarily system-level components, kernels, drivers, and service packages
# that are not meaningful to restore as user applications.
